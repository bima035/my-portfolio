  ...
  return (
    <footer className="bg-gray-700 text-white py-8 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Brand */}
        <div>
          <h2 className="text-xl text-blue-400" style={{fontFamily: 'satoshi-black'}}>Bima Hanan Maulidyarta</h2>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center text-gray-400 text-sm">
        © {new Date().getFullYear()} Bima Hanan Maulidyarta. All rights reserved.
      </div>
    </footer>
  )
}
